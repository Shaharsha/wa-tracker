  ...
  if (tab === "dismissed") {
    return (
      <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
        ...
        <p className="font-serif text-lg text-stone-400">No dismissed contacts</p>
        <p className="text-xs text-stone-300 mt-1">Contacts you dismiss will appear here.</p>
      </div>
    );
  }
